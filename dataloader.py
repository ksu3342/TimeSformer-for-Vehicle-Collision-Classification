...
def read_videos(video_folder_path, label):
    ...
    for video_file in video_files:
        ...
        cap.release()
# 读取negative类别的视频
read_videos('/home/sunyvbo/demo1/dataset/test/negative', 0)
read_videos('/home/sunyvbo/demo1/dataset/test/negative', 0)

# 读取positive类别的视频
read_videos('/home/sunyvbo/demo1/dataset/test/positive', 1)
read_videos('/home/sunyvbo/demo1/dataset/test/positive', 1)
...
#返回负样本的视频总数
video_files1 = [f for f in os.listdir('/home/sunyvbo/demo1/dataset/test/negative') if f.endswith('.mp4')]
print('Number of  negative video files:', len(video_files1))

#返回正样本的视频总数
video_files2 = [f for f in os.listdir('/home/sunyvbo/demo1/dataset/test/positive') if f.endswith('.mp4')]
...
# 每个视频都有两个标签，0和1，后面要做二分类判断的，写着写着居然晕啦？
